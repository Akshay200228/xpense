      ...
      <div className='container mx-auto'>
        <div className='flex flex-col items-center text-center lg:flex-row lg:items-start lg:text-left lg:justify-between gap-y-8'>
          ...
          <div data-aos='fade-up' data-aos-offset='200' data-aos-delay='500'>
            <div className='mb-6 text-2xl font-medium uppercase'>Links</div>
          ...
          <div data-aos='fade-up' data-aos-offset='200' data-aos-delay='700'>
            <div className='mb-6 text-2xl font-medium uppercase'>Legal</div>
            <ul className='flex flex-col gap-y-3'>
              {links.map((item, index) => {
                // destructure item
                const { href, name } = item;
          ...
          <div data-aos='fade-up' data-aos-offset='200' data-aos-delay='900'>
            <div className='mb-6 text-2xl font-medium uppercase'>
              {newsletter.title}
            </div>
